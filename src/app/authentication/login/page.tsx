...
export default function Page() {
  ...
  const handleLogin = () => {
    // Here you can also validate the email or call a login API
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-6 bg-white p-6 rounded-xl">
        ...
        <div className="space-y-3 mt-8">
          <button className="relative flex items-center justify-center w-full border border-gray-300 rounded-xl py-2 px-4 pl-10 text-sm font-medium text-gray-900 hover:bg-gray-50 transition-colors">
          ...
          <button className="relative flex items-center justify-center w-full border border-gray-300 rounded-xl py-2 px-4 pl-10 text-sm font-medium text-gray-900 hover:bg-gray-50 transition-colors">
            {/* Apple SVG icon absolutely positioned on the left */}
